export const userFlags = {
  ...
  Founder: 1n << 5n,
  Tester: 1n << 6n,
  // 7–15 reserved for future identities
...
export const staffToggleableUserFlags = [
  "Staff",
  "Verified",
  "Tester",
  "Employee",
  ...
  "CommunityHelper",
  "AgeConfirmed18Plus",
] as const satisfies readonly UserFlag[];

export type StaffToggleableUserFlag = (typeof staffToggleableUserFlags)[number];

export const isStaffToggleableUserFlag = (
  flag: string,
): flag is StaffToggleableUserFlag =>
  (staffToggleableUserFlags as readonly string[]).includes(flag);
