# Contributing to @mutualzz/bitfield

Thanks for wanting to help with **@mutualzz/bitfield**.

Contributions are welcome. Redistributing unofficial builds or hosting a
competing Mutualzz service is still not allowed — see [`LICENSE`](https://github.com/Mutualzz/bitfield/blob/master/LICENSE).
